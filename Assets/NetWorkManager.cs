...
public class NetWorkManager : MonoBehaviourPunCallbacks
{
    ...
    #region ��������
    void Awake() => Screen.SetResolution(1900, 1060, false);
    ...
    public void RoomRenewal()
    {
        ...
        RoomInfo.text = PhotonNetwork.CurrentRoom.Name + " / " + PhotonNetwork.CurrentRoom.PlayerCount + "�� / " + PhotonNetwork.CurrentRoom.MaxPlayers + "�ִ�";
    }
    #endregion
